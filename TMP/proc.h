...
struct	pentry	{
	...
	int	pwaitret;
	int isRT;			/* flag to indicate realtime process*/
	int eprio;			/* process prio for current epoch required since priority changes should reflect only after end of epoch*/
	int quanta_left;		/* number of quanta left for a process*/
	int goodness;
};
